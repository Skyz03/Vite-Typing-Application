...
export function TextDisplay({
  ...
  return (
    <div className="relative mx-auto w-full max-w-4xl px-4 py-8">
      ...
      <div className="font-mono text-2xl md:text-3xl leading-relaxed tracking-wide break-all whitespace-pre-wrap outline-none">
        {characters.map((char, i) => {
          ...
          return (
            <span
              key={i}
              className={`relative transition-colors duration-100 select-none ${isCorrect
            ...
            >
              ...
              {isCurrent && (
                <span className="absolute -left-[2px] top-1 bottom-1 w-[2.5px] rounded-full bg-type-primary animate-pulse shadow-[0_0_10px_rgba(0,113,227,0.4)] z-10" />
              )}
